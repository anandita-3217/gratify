  ...
  return (
    <Stack gap="lg">
      <Stack gap="xs">
        ...
        <Text size="xs" c="dimmed">Download all your tasks, notes, events and settings as a JSON file</Text>
        <Button leftSection={<Download size={14}/>} variant="light" color="pink" w="fit-content" onClick={exportData}>
          Export
        </Button>
      </Stack>
      ...
      <Stack gap="xs">
        ...
        <Text size="xs" c="dimmed">Restore from a previously exported JSON file</Text>
        <Button leftSection={<Upload size={14}/>} variant="light" color="blue" w="fit-content" onClick={importData}>
          Import
        </Button>
      </Stack>
      ...
      <Stack gap="xs">
        ...
        <Text size="xs" c="dimmed">Permanently delete all tasks, notes, events and settings. This cannot be undone.</Text>
        <Button leftSection={<Trash size={14}/>} variant="light" color="red" w="fit-content" onClick={clearData}>
          Clear All Data
        </Button>
      </Stack>
    </Stack>
