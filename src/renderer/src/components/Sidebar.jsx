...
//   )
// }
import { CheckSquare, ListChecks ,LayoutDashboard,TextAlignJustify, Calendar,Timer ,ChartLine      } from 'lucide-react'
...
export default function Sidebar(){
  ...
  return (
    <Stack>
      <NavItem icon={<CheckSquare size={20}/>} label="Tasks" isActive = {activePage === 'tasks'} onClick = {() => setActivePage('tasks')}/>
      <NavItem icon={<TextAlignJustify size={20}/>} label="Notes"/>
    </Stack>
  );
}